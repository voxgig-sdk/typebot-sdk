...
// Typebot SDK utility: fetcher

class TypebotFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TypebotSDK/1.0)';
    ...
    public static function call(TypebotContext $ctx, string $fullurl, array $fetchdef): array
    {
