...
class TypebotGraphql
{
    ...
    // equivalent.
    public static function body(TypebotContext $ctx): mixed
    {
    ...
    public static function errors(TypebotContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
