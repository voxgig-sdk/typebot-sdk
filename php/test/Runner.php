...
class TypebotTestRunner
{
    ...
    {
        $live = self::getenv('TYPEBOT_TEST_LIVE');
        $override = self::getenv('TYPEBOT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TYPEBOT_TEST_EXPLAIN');
...
class_alias('TypebotTestRunner', 'Runner');
class_alias('TypebotHelpers', 'Helpers');
