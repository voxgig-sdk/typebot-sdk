...
// Typebot SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TypebotSDK::test)
...
{
    private const SDK_CLASS = 'TypebotSDK';
    ...
    private const SDK_BASE = 'typebot_sdk';
