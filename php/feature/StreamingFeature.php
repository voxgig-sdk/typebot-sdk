...
class TypebotStreamingFeature extends TypebotBaseFeature
{
    ...
    private function _iterate(TypebotResult $result): \Generator
    {
    ...
    private function _streamable(TypebotContext $ctx): bool
    {
