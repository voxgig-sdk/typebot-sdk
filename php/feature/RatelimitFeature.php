...
class TypebotRatelimitFeature extends TypebotBaseFeature
{
    ...
    private function _acquire(TypebotContext $ctx): void
    {
    ...
    private function _track(TypebotContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
