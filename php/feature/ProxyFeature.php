...
class TypebotProxyFeature extends TypebotBaseFeature
{
    ...
    public function init(TypebotContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TypebotContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
