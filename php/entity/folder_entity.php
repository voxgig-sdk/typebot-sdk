...
class FolderEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FolderEntity($this->_client, $opts);
    }

    /**
     * @param Folder|array $args Folder data (assoc-array) to store.
     */
    ...
    /**
     * @return Folder|array The current Folder data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Folder fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Folder fields).
     */
     ...
     *
     * @param FolderLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FolderLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Folder|array The loaded Folder as an assoc-array at the
    ...
    /**
     * List Folder items matching the given filter.
     *
     * @param FolderListMatch|array|null $reqmatch Match filter (any subset
     *   of Folder fields) as an assoc-array; FolderListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Folder[]|array A list of Folder items as assoc-arrays at
     ...
     * Create a new Folder.
     *
     * @param FolderCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FolderCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Folder|array The created Folder as an assoc-array at the
     *   SDK boundary; throws TypebotError on failure (item-5 convention).
     */
     ...
     *
     * @param FolderUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FolderUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Folder|array The updated Folder as an assoc-array at the
     *   SDK boundary; throws TypebotError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Folder matching the given criteria.
     *
     * @param FolderRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FolderRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Folder|array The removed Folder as an assoc-array at the
     *   SDK boundary; throws TypebotError on failure (item-5 convention).
     */
