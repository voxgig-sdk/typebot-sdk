...
class BillingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BillingEntity($this->_client, $opts);
    }

    /**
     * @param Billing|array $args Billing data (assoc-array) to store.
     */
    ...
    /**
     * @return Billing|array The current Billing data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Billing fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Billing fields).
     */
    ...
    /**
     * Load a single Billing.
     *
     * @param BillingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BillingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Billing|array The loaded Billing as an assoc-array at the
    ...
    /**
     * List Billing items matching the given filter.
     *
     * @param BillingListMatch|array|null $reqmatch Match filter (any subset
     *   of Billing fields) as an assoc-array; BillingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Billing[]|array A list of Billing items as assoc-arrays at
