...
class WorkspaceEntity
{
     ...
     *
     * @param WorkspaceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorkspaceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workspace|array The loaded Workspace as an assoc-array at the
     ...
     *
     * @param WorkspaceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WorkspaceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workspace|array The created Workspace as an assoc-array at the
     *   SDK boundary; throws TypebotError on failure (item-5 convention).
     */
     ...
     *
     * @param WorkspaceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WorkspaceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workspace|array The updated Workspace as an assoc-array at the
     *   SDK boundary; throws TypebotError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Workspace matching the given criteria.
     *
     * @param WorkspaceRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; WorkspaceRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workspace|array The removed Workspace as an assoc-array at the
     *   SDK boundary; throws TypebotError on failure (item-5 convention).
     */
