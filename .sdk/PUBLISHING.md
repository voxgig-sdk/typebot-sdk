...
|---|---|---|
| `js/` | @voxgig-sdk/typebot-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/typebot | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/typebot-js \
      --repository voxgig-sdk/typebot-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/typebot-js` shows it, and
`npm trust revoke @voxgig-sdk/typebot-js --id=<id>` removes it.
