...
class TypebotTimeoutFeature extends TypebotBaseFeature
{
    ...
    private function _with_timeout(TypebotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TypebotContext $_ctx, float $ms): void
    {
        $client = $this->client;
