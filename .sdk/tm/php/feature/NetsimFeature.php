...
class TypebotNetsimFeature extends TypebotBaseFeature
{
    ...
    private function _simulate(TypebotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TypebotContext $ctx, array $applied): void
    {
        $client = $this->client;
