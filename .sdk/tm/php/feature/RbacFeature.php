...
class TypebotRbacFeature extends TypebotBaseFeature
{
    ...
    private function _required(TypebotContext $ctx): ?string
    {
    ...
    private function _reject(TypebotContext $ctx, string $required): void
    {
    ...
    private function _track(TypebotContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
