...
class TypebotCacheFeature extends TypebotBaseFeature
{
    ...
    private function _through(TypebotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
