...
// Typebot SDK clienttrack feature
...
class TypebotClienttrackFeature extends TypebotBaseFeature
{
    ...
    public function PostConstruct(TypebotContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Typebot-SDK';
