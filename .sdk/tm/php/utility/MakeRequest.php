...
// Typebot SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TypebotMakeRequest
{
    public static function call(TypebotContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TypebotResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TypebotResponse($fetched);
        } else {
