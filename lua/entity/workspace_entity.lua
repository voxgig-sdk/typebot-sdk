...
---@param reqmatch WorkspaceLoadMatch
---@param ctrl? table
---@return Workspace
---@return string? err
function WorkspaceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata WorkspaceCreateData
---@param ctrl? table
---@return Workspace
---@return string? err
function WorkspaceEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata WorkspaceUpdateData
---@param ctrl? table
---@return Workspace
---@return string? err
function WorkspaceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch WorkspaceRemoveMatch
---@param ctrl? table
---@return Workspace
---@return string? err
function WorkspaceEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
