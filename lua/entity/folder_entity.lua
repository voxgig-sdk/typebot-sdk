...
local FolderEntity = {}
FolderEntity.__index = FolderEntity


function FolderEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FolderEntity)
  self._name = "folder"
  self._client = client
...
function FolderEntity:get_name()
  return self._name
end


function FolderEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FolderEntity.new(self._client, opts)
end
...
function FolderEntity:mark_deleted()
  self._deleted = true
end


function FolderEntity:deleted()
  return true == self._deleted
end


function FolderEntity:data_set(args)
  if args ~= nil then
...
function FolderEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FolderEntity:match_set(args)
  if args ~= nil then
...
function FolderEntity:match_get()
...
function FolderEntity:stream(action, args, callopts)
...
---@param reqmatch FolderLoadMatch
---@param ctrl? table
---@return Folder
---@return string? err
function FolderEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch FolderListMatch
---@param ctrl? table
---@return Folder[]
---@return string? err
function FolderEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata FolderCreateData
---@param ctrl? table
---@return Folder
---@return string? err
function FolderEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata FolderUpdateData
---@param ctrl? table
---@return Folder
---@return string? err
function FolderEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch FolderRemoveMatch
---@param ctrl? table
---@return Folder
---@return string? err
function FolderEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function FolderEntity:_run_op(ctx, post_done)
  local utility = self._utility
