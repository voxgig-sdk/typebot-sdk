...
function TypebotEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TypebotEntity)
  self._name = "typebot"
  self._client = client
...
function TypebotEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TypebotEntity.new(self._client, opts)
end
...
function TypebotEntity:mark_deleted()
  self._deleted = true
end


function TypebotEntity:deleted()
  return true == self._deleted
end


function TypebotEntity:data_set(args)
  if args ~= nil then
...
function TypebotEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TypebotEntity:match_set(args)
  if args ~= nil then
...
function TypebotEntity:match_get()
...
function TypebotEntity:stream(action, args, callopts)
