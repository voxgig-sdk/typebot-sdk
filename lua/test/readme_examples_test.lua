...
-- data to return.
local TEST_SEED = '{ entity = { ["analytics"] = { ["test01"] = { id = "test01" } }, ["billing"] = { ["test01"] = { id = "test01" } }, ["folder"] = { ["test01"] = { id = "test01" } }, ["result"] = { ["test01"] = { id = "test01" } }, ["typebot"] = { ["test01"] = { id = "test01" } }, ["workspace"] = { ["test01"] = { id = "test01" } } } }'
