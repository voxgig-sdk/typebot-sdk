...
describe("ResultEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TYPEBOT_TEST_RESULT_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local result_ref01_data_dt0_load_result = helpers.to_map(result_ref01_data_dt0_loaded)
