...
type Args struct {
	Entity string         `json:"entity" jsonschema:"analytics | billing | folder | result | typebot | workspace"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TypebotSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "typebot_list",
		Description: "List records from Typebot. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "typebot_load",
		Description: "Load a single record from Typebot. " +
...
func runOp(client *sdk.TypebotSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TypebotSDK, name string) (sdk.TypebotEntity, error) {
	...
	case "folder":
		return client.Folder(nil), nil
	case "result":
		return client.Result(nil), nil
	case "typebot":
		return client.Typebot(nil), nil
	case "workspace":
