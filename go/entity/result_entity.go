...
func NewResultEntity(client *core.TypebotSDK, entopts map[string]any) *ResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResultEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResultLoadMatch and returns an Result. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ResultEntity) LoadTyped(reqmatch ResultLoadMatch, ctrl map[string]any) (Result, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Result{}, err
	}
	return typedFrom[Result](res), nil
}
...
// ResultRemoveMatch and returns an Result. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ResultEntity) RemoveTyped(reqmatch ResultRemoveMatch, ctrl map[string]any) (Result, error) {
