...
func NewBillingEntity(client *core.TypebotSDK, entopts map[string]any) *BillingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BillingEntity) GetName() string { return e.name }
...
func (e *BillingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BillingEntity) Deleted() bool {
	return e.deleted
}


func (e *BillingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBillingEntity(e.client, opts)
}

func (e *BillingEntity) Data(args ...any) any {
...
func (e *BillingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Billing; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BillingEntity) DataTyped(data ...Billing) Billing {
	if len(data) > 0 {
		return typedFrom[Billing](e.Data(asMap(data[0])))
	}
	return typedFrom[Billing](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Billing (all fields
// optional at the wire level).
func (e *BillingEntity) MatchTyped(match ...Billing) Billing {
	if len(match) > 0 {
		return typedFrom[Billing](e.Match(asMap(match[0])))
	}
	return typedFrom[Billing](e.Match())
}
...
func (e *BillingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BillingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BillingLoadMatch and returns an Billing. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BillingEntity) LoadTyped(reqmatch BillingLoadMatch, ctrl map[string]any) (Billing, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Billing{}, err
	}
	return typedFrom[Billing](res), nil
}




func (e *BillingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// BillingListMatch and returns []Billing. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BillingEntity) ListTyped(reqmatch BillingListMatch, ctrl map[string]any) ([]Billing, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Billing](res), nil
}



func (e *BillingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BillingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BillingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BillingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
