...
func NewAnalyticsEntity(client *core.TypebotSDK, entopts map[string]any) *AnalyticsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnalyticsEntity) GetName() string { return e.name }
...
func (e *AnalyticsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnalyticsEntity) Deleted() bool {
	return e.deleted
}


func (e *AnalyticsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnalyticsEntity(e.client, opts)
}

func (e *AnalyticsEntity) Data(args ...any) any {
...
func (e *AnalyticsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Analytics; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AnalyticsEntity) DataTyped(data ...Analytics) Analytics {
	if len(data) > 0 {
		return typedFrom[Analytics](e.Data(asMap(data[0])))
	}
	return typedFrom[Analytics](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Analytics (all fields
// optional at the wire level).
func (e *AnalyticsEntity) MatchTyped(match ...Analytics) Analytics {
	if len(match) > 0 {
		return typedFrom[Analytics](e.Match(asMap(match[0])))
	}
	return typedFrom[Analytics](e.Match())
}
...
func (e *AnalyticsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnalyticsEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AnalyticsLoadMatch and returns an Analytics. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AnalyticsEntity) LoadTyped(reqmatch AnalyticsLoadMatch, ctrl map[string]any) (Analytics, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Analytics{}, err
	}
	return typedFrom[Analytics](res), nil
}



func (e *AnalyticsEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AnalyticsEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnalyticsEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnalyticsEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnalyticsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
