...
func NewFolderEntity(client *core.TypebotSDK, entopts map[string]any) *FolderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FolderEntity) GetName() string { return e.name }
...
func (e *FolderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FolderEntity) Deleted() bool {
	return e.deleted
}


func (e *FolderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFolderEntity(e.client, opts)
}

func (e *FolderEntity) Data(args ...any) any {
...
func (e *FolderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Folder; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FolderEntity) DataTyped(data ...Folder) Folder {
	if len(data) > 0 {
		return typedFrom[Folder](e.Data(asMap(data[0])))
	}
	return typedFrom[Folder](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Folder (all fields
// optional at the wire level).
func (e *FolderEntity) MatchTyped(match ...Folder) Folder {
	if len(match) > 0 {
		return typedFrom[Folder](e.Match(asMap(match[0])))
	}
	return typedFrom[Folder](e.Match())
}
...
func (e *FolderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FolderEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FolderLoadMatch and returns an Folder. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FolderEntity) LoadTyped(reqmatch FolderLoadMatch, ctrl map[string]any) (Folder, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Folder{}, err
	}
	return typedFrom[Folder](res), nil
}




func (e *FolderEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FolderListMatch and returns []Folder. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FolderEntity) ListTyped(reqmatch FolderListMatch, ctrl map[string]any) ([]Folder, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Folder](res), nil
}




func (e *FolderEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// FolderCreateData and returns an Folder. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FolderEntity) CreateTyped(reqdata FolderCreateData, ctrl map[string]any) (Folder, error) {
...
func (e *FolderEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// FolderUpdateData and returns an Folder. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *FolderEntity) UpdateTyped(reqdata FolderUpdateData, ctrl map[string]any) (Folder, error) {
...
func (e *FolderEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// FolderRemoveMatch and returns an Folder. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FolderEntity) RemoveTyped(reqmatch FolderRemoveMatch, ctrl map[string]any) (Folder, error) {
...
func (e *FolderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
