...
const testSeed = `map[string]any{"entity": map[string]any{"analytics": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "billing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "folder": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "typebot": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "workspace": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
