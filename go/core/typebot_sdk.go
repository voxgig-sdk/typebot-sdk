...
func (sdk *TypebotSDK) OptionsMap() map[string]any {
...
func (sdk *TypebotSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TypebotSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TypebotSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TypebotSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TypebotSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TypebotSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TypebotSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TypebotSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TypebotSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TypebotSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *TypebotSDK) Analytics(data map[string]any) TypebotEntity {
...
func (sdk *TypebotSDK) Billing(data map[string]any) TypebotEntity {
	return NewBillingEntityFunc(sdk, data)
}


// Folder returns a Folder entity bound to this client.
// Idiomatic usage: client.Folder(nil).List(nil, nil) or
// client.Folder(nil).Load(map[string]any{"id": ...}, nil).
func (sdk *TypebotSDK) Folder(data map[string]any) TypebotEntity {
	return NewFolderEntityFunc(sdk, data)
}
...
func (sdk *TypebotSDK) Result(data map[string]any) TypebotEntity {
	return NewResultEntityFunc(sdk, data)
}


// Typebot returns a Typebot entity bound to this client.
// Idiomatic usage: client.Typebot(nil).List(nil, nil) or
// client.Typebot(nil).Load(map[string]any{"id": ...}, nil).
func (sdk *TypebotSDK) Typebot(data map[string]any) TypebotEntity {
	return NewTypebotEntityFunc(sdk, data)
}
...
func (sdk *TypebotSDK) Workspace(data map[string]any) TypebotEntity {
