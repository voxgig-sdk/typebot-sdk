...
function envOverride(m) {
    if ('TRUE' === process.env.TYPEBOT_TEST_LIVE ||
        'TRUE' === process.env.TYPEBOT_TEST_OVERRIDE) {
    ...
    m.TYPEBOT_TEST_EXPLAIN = process.env.TYPEBOT_TEST_EXPLAIN || m.TYPEBOT_TEST_EXPLAIN;
    return m;
}
