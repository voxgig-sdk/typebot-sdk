...
(0, node_test_1.describe)('ResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-result', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-result', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["typebot01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TYPEBOT_TEST_RESULT_ENTID'];
