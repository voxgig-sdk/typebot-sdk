...
(0, node_test_1.describe)('TypebotDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-typebot', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-typebot', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-typebot', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-typebot', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TypebotSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.TYPEBOT_APIKEY,
        }));
        let idmap = env['TYPEBOT_TEST_TYPEBOT_ENTID'];
...
//# sourceMappingURL=TypebotDirect.test.js.map