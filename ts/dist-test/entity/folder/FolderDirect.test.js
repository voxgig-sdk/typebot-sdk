...
(0, node_test_1.describe)('FolderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-folder', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-folder', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-folder', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-folder', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TYPEBOT_TEST_FOLDER_ENTID'];
...
//# sourceMappingURL=FolderDirect.test.js.map