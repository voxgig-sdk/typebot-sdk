...
class AnalyticsEntity extends TypebotEntityBase<Analytics> {
  ...
  make(this: AnalyticsEntity) {
    return new AnalyticsEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AnalyticsLoadMatch, ctrl?: Control): Promise<AnalyticsEntity> {
