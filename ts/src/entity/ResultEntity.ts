...
class ResultEntity extends TypebotEntityBase<Result> {
  ...
  async load(this: any, reqmatch?: ResultLoadMatch, ctrl?: Control): Promise<ResultEntity> {
  ...
  async remove(
    this: any, reqmatch?: ResultRemoveMatch, ctrl?: Control,
