...
def make_error_util(ctx, err):
    if ctx is None:
        from typebot_sdk.core.context import TypebotContext
        ctx = TypebotContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, TypebotError):
        errmsg = err.msg
