...
from typebot_sdk.utility import register

# Load features
from typebot_sdk.feature.base_feature import TypebotBaseFeature
from typebot_sdk.features import _has_feature, _make_feature
...
class TypebotSDK:
    ...
    def get_utility(self):
        return TypebotUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TypebotSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Analytics(self, data=None) -> "AnalyticsEntity":
        ...
        from typebot_sdk.entity.analytics_entity import AnalyticsEntity
    ...
    def Billing(self, data=None) -> "BillingEntity":
        ...
        from typebot_sdk.entity.billing_entity import BillingEntity
        return BillingEntity(self, data)


    def Folder(self, data=None) -> "FolderEntity":
        """Entity factory: client.Folder().list() / client.Folder().load({"id": ...})."""
        from typebot_sdk.entity.folder_entity import FolderEntity
        return FolderEntity(self, data)


    def Result(self, data=None) -> "ResultEntity":
        """Entity factory: client.Result().list() / client.Result().load({"id": ...})."""
        from typebot_sdk.entity.result_entity import ResultEntity
        return ResultEntity(self, data)


    def Typebot(self, data=None) -> "TypebotEntity":
        """Entity factory: client.Typebot().list() / client.Typebot().load({"id": ...})."""
        from typebot_sdk.entity.typebot_entity import TypebotEntity
        return TypebotEntity(self, data)


    def Workspace(self, data=None) -> "WorkspaceEntity":
        """Entity factory: client.Workspace().list() / client.Workspace().load({"id": ...})."""
        from typebot_sdk.entity.workspace_entity import WorkspaceEntity
        return WorkspaceEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "TypebotSDK":
        if sdkopts is None:
            sdkopts = {}
