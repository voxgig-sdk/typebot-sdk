...
from typebot_sdk.core.helpers import get_ctx_prop, to_map
...
class TypebotContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TypebotResponse):
            self.response = rp
        elif basectx is not None:
