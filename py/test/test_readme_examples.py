# Typebot SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TypebotSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TypebotSDK(...) and TypebotSDK.test(...) become
#      TypebotSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "typebot_sdk"
_SDK_CLASS = "TypebotSDK"
