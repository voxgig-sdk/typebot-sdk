...
from typebot_sdk.core.operation import TypebotOperation
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TypebotSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TypebotSDK.test(None, None)
        ...
        class TestInitFeature(TypebotBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TypebotBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TypebotSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TypebotSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TypebotSDK.test(None, setup_opts)
