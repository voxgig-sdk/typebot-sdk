...
func registerSDKWords(r *eng.Registry, client *sdk.TypebotSDK) {
...
func runOp(client *sdk.TypebotSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
